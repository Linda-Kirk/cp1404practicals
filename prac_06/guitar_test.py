"""CP1404 Practical - Client code to use and the Guitar class."""
...
def main():
    ...
    print(first_guitar, ". Age: {}, Vintage: {} - expected ".format(first_guitar.get_age(), first_guitar.is_vintage()))
    print(another_guitar,
          ". Age: {}, Vintage: {} - expected ".format(another_guitar.get_age(), another_guitar.is_vintage()))
